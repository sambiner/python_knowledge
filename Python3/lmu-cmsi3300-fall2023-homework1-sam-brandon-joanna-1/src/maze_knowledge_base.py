...
class MazeKnowledgeBase:
    ...
    def __init__(self) -> None:
        ...
        MazeClauses of any kind. It begins as an empty knowledgebase with no 
        contained clauses.
        """
    ...
    def ask(self, query: "MazeClause") -> bool:
        ...
        negated_query_props = [(prop, not val) for prop, val in query.props.items()]
        negated_query = MazeClause(negated_query_props)
        ...
        while True:
            for c1, c2 in itertools.combinations(clauses, 2):
                resolvents = MazeClause.resolve(c1, c2)
